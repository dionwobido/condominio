...
class ContaReceberList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->addFilterField('data_vencimento', '=','data_vencimento');
        $this->addFilterField('pessoa_id', 'like','pessoa_id');
        $this->addFilterField('valor', 'like','valor');
        ...
        $data_recebimento = new TEntry('data_recebimento');
        ...
        $action1 = new TDataGridAction(['ContaReceberForm', 'onEdit'], ['id' =>'{id}', 'register_start' =>'false']);
