...
class PessoaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setDefaultOrder('id', 'asc');// ordena por id
        $this->setLimit(10);//limite da quantidade por pagina
        ...
        $grupo_id = new TDBUniqueSearch('grupo_id', 'db_condominio', 'Grupo', 'id', 'nome_fantasia');
        $grupo_id->setMinLength(0);

        $this->form->addFields([new TLabel('Id')], [$id]);
        $this->form->addFields([new TLabel('Nome_fantasia')], [$nome_fantasia]);
        ...
        $column_nome_fantasia = new TDataGridColumn('nome_fantasia', 'Nome_fantasia', 'left');
        ...
        $this->datagrid->addAction($action1, _t('View'), 'fa:serch gray');
        $this->datagrid->addAction($action2, _t('Edit'), 'far:edit blue');
        $this->datagrid->addAction($action3, _t('Delete'), 'far:edtrashit red');
